...
**Note:** v4.0+ auto-installs bcrypt, so this should not happen. See [docs/PASSWORD_MANAGEMENT_GUIDE.md](PASSWORD_MANAGEMENT_GUIDE.md) for details.
...
| Problème | Doc |
|----------|-----|
| HTTPS | docs/HTTPS_CONFIGURATION.md |
