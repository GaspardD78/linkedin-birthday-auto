...
from .routes import deployment, bot_control, debug_routes, automation_control, notifications, scheduler_routes, visitor_routes, campaign_routes  # Import the routers
